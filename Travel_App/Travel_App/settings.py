...
SECRET_KEY = 'django-insecure-ao_1)4l))ndda#6hxrr4h4%eu!4#8y==8eyuj2dg)@)#=5ew^r'
...
#    'default': {
#        'ENGINE': 'djongo',
#        'NAME': 'Travel_App',  # Replace with your database name
...
#            'authSource': 'admin',  # Optional, specify the auth source if needed
#        }
#    }
#}
...
LOGIN_REDIRECT_URL = '/app1/login/homepage.html'
